...
print("Valdis" == 55, my_name == 253253)
# # # #
# # # # # inequality
print(a,b)
print(a != b)  # if they are inequal then != will give True
print(2 != 2, a != 2)  # this is a False statement because 2 is in fact equal to 2
...
print(chr(86), chr(97), chr(257), chr(8000), chr(128512))  # i can print from codes the symbols
# # # #
